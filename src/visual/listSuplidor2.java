...
public class listSuplidor2 extends JFrame {
	...
	private JButton btnRegSuplidor;
	/**
	...
	public listSuplidor2(Connection con) {
		...
		btnModificarS.setBackground(Color.WHITE);
		...
		btnModificarS.setBounds(388, 73, 162, 23);
		panel.add(btnModificarS);
		
		
		btnEliminarS = new JButton("Eliminar suplidor");
		btnEliminarS.setBackground(Color.WHITE);
		...
		btnEliminarS.setBounds(745, 73, 162, 23);
		panel.add(btnEliminarS);
		
		btnProductoSuplidor = new JButton("Productos del suplidor");
		btnProductoSuplidor.setBackground(Color.WHITE);
		...
		btnProductoSuplidor.setBounds(560, 73, 175, 23);
		panel.add(btnProductoSuplidor);
		
		btnRegSuplidor = new JButton("Registrar suplidor");
		btnRegSuplidor.setBackground(Color.WHITE);
		btnRegSuplidor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				RegSuplidor rgS = new RegSuplidor(con);
				rgS.setVisible(true);
				
			}
		});
		btnRegSuplidor.setBounds(203, 73, 175, 23);
		panel.add(btnRegSuplidor);
